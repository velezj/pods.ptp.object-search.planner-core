...
#if !defined( __PLANNER_CORE_random_planner_HPP__ )
#define __PLANNER_CORE_random_planner_HPP__
...
namespace planner_core {
  ...
  // Description:
  // A grid planner which chose random next action
  class random_planner_t
