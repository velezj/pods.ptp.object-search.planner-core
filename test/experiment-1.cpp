...
int main( int argc, char** argv )
{
  ...
  model.ruler_length_distribution.p = 8*8*8*8;
  model.ruler_length_distribution.q = 8+8+8+8;
  ...
  model.ruler_start_mean_distribution.covariance = to_dense_mat( Eigen::MatrixXd::Identity(dim,dim) * 100 );
