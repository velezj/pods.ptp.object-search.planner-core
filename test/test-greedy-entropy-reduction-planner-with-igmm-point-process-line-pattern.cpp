...
#include <planner-core/greedy_entropy_reduction_planner.hpp>
#include <iostream>
#include <algorithm>
#include <iomanip>
...
void draw_cells( bot_lcmgl_t* lcmgl,
		 const greedy_entropy_reduction_planner_t& planner,
...
int main( int argc, char** argv )
{
  ...
  greedy_entropy_reduction_planner_t planner( process,
					      planner_params,
					      entropy_params,
